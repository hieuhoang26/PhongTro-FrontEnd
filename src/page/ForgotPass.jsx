          ...
          {currentStep === "verify_code" && (
            <div>
              <div className="alert bg-green-100 text-green-800 rounded-lg p-4 mb-6 flex items-start">
                ...
                <div>
                  <p className="m-0">
                    Mã xác nhận đã được gửi đến {phoneEmail}
                  </p>
                  <p className="m-0">
              ...
              <form className="space-y-4" onSubmit={handleSubmitSecondStep}>
                <div className="form-floating mb-3 relative">
                  <input
                    type="text"
                    id="verify_code"
                ...
                <div className="flex gap-4 mt-6">
                  <button
                    type="button"
                    onClick={() => setCurrentStep("verify_account")}
                    className="w-full py-3 bg-gray-200 text-gray-800 rounded-xl text-lg font-semibold"
                  >
                    Quay lại
                  </button>
                  <button
